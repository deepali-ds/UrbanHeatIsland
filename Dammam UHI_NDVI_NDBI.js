// =================== Dammam UHI + NDVI/NDBI Analysis ===================

// 1) Define city center and ROI
var cityCenter = ee.Geometry.Point([50.06395, 26.4011]);
var roi = cityCenter.buffer(5000).bounds();  // 10 km box
Map.setCenter(50.06395, 26.4011, 12);
Map.addLayer(roi, {color:'red'}, 'Dammam ROI');
