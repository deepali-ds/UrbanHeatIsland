// =================== Dammam UHI Visualization ===================

// 1) Define city center and ROI (30 km buffer)
var cityCenter = ee.Geometry.Point([50.06395, 26.4011]);

var roi = cityCenter.buffer(30000);   // 30 km = 30,000 meters

Map.setCenter(50.06395, 26.4011, 10);
Map.addLayer(roi, {color: 'red'}, 'Dammam 30km ROI');
...
Export.image.toDrive({
  image: uhiVis2020,
  description:'UHI_2020_Dammam_30km_RGB',
  fileFormat:'GeoTIFF',
  region: roi,
  scale: 100
});
...
Export.image.toDrive({
  image: uhiVis2024,
  description:'UHI_2024_Dammam_30km_RGB',
  fileFormat:'GeoTIFF',
  region: roi,
  scale: 100
});
